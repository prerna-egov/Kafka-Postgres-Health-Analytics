...
WITH ben_level AS (
    SELECT
        pb.tenant_id, pb.campaign_number, pb.region_code, pb.district_code, pb.healthfacility_code, pb.settlement_code, pb.beneficiary_id,
    ...
    GROUP BY pb.tenant_id, pb.campaign_number, pb.region_code, pb.district_code, pb.healthfacility_code, pb.settlement_code, pb.beneficiary_id
)
SELECT
...
SELECT
    t.tenant_id, t.campaign_number, t.region_code, t.district_code, t.healthfacility_code, t.settlement_code,
...
GROUP BY t.tenant_id, t.campaign_number, t.region_code, t.district_code, t.healthfacility_code, t.settlement_code;

CREATE UNIQUE INDEX idx_dm_task_status_base ON dm_task_status_base (tenant_id, campaign_number, region_code, district_code, healthfacility_code, settlement_code);
-- Indices removed based on audit report (redundant to UNIQUE INDEX)
...
CREATE UNIQUE INDEX idx_dm_refusal_breakdown ON dm_refusal_breakdown (tenant_id, campaign_number, region_code, district_code, healthfacility_code, settlement_code, refusal_reason);
...
CREATE UNIQUE INDEX idx_dm_absence_breakdown ON dm_absence_breakdown (tenant_id, campaign_number, region_code, district_code, healthfacility_code, settlement_code, absence_category);
...
CREATE UNIQUE INDEX idx_dm_settlement_refusal_rate ON dm_settlement_refusal_rate (tenant_id, campaign_number, region_code, district_code, healthfacility_code, settlement_code, settlement_type);
