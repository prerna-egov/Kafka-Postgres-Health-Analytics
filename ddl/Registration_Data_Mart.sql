...
GROUP BY 
    pb.beneficiary_id, pb.campaign_number,
...
CREATE UNIQUE INDEX idx_dm_reg_ben_base ON dm_registration_beneficiary_base (beneficiary_id, COALESCE(campaign_number, 'NONE'));
...
CREATE UNIQUE INDEX idx_dm_reg_metrics_base ON dm_registration_metrics_base (campaign_number, region_code, district_code, healthfacility_code, settlement_code, age_band, gender, settlement_type);
...
CREATE UNIQUE INDEX idx_dm_hh_metrics_base ON dm_household_metrics_base (campaign_number, region_code, district_code, healthfacility_code, settlement_code);
...
CREATE INDEX IF NOT EXISTS idx_reg_metrics_campaign_region ON dm_registration_metrics_base (campaign_number, region_code);
CREATE INDEX IF NOT EXISTS idx_reg_metrics_campaign_district ON dm_registration_metrics_base (campaign_number, district_code);
CREATE INDEX IF NOT EXISTS idx_reg_metrics_campaign_hc ON dm_registration_metrics_base (campaign_number, healthfacility_code);
CREATE INDEX IF NOT EXISTS idx_reg_metrics_campaign_village ON dm_registration_metrics_base (campaign_number, settlement_code);

-- Indexes for dm_household_metrics_base
CREATE INDEX IF NOT EXISTS idx_hh_metrics_campaign_region ON dm_household_metrics_base (campaign_number, region_code);
CREATE INDEX IF NOT EXISTS idx_hh_metrics_campaign_district ON dm_household_metrics_base (campaign_number, district_code);
CREATE INDEX IF NOT EXISTS idx_hh_metrics_campaign_hc ON dm_household_metrics_base (campaign_number, healthfacility_code);
CREATE INDEX IF NOT EXISTS idx_hh_metrics_campaign_village ON dm_household_metrics_base (campaign_number, settlement_code);
